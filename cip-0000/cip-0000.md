...
After investigating past work, the best way to proceed is by posting about the new idea to the [https://lists.sync.global/g/cip-discuss] mailing list.
...
Once the champion has asked the Global Synchronizer community whether an idea has any chance of acceptance, a draft CIP should be presented to the [https://lists.sync.global/g/cip-discuss] mailing list.
...
When the CIP draft is complete, a CIP editor will assign the CIP a number, label it as Standards Track, Governance, Tokenomics, Process or Informational, and merge the pull request to the CIPs git repository.
